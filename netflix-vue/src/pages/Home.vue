<template>
  <!--<div>
    <h2>Meu componete! {{nomeProjeto}}</h2>
  </div>-->
  <div class="contain">
    <!--<categoria titulo="Comédia"><categoria>
    <categoria titulo="Suspense"><categoria>-->
    <categoria v-for="categoria in categorias" v-bind:key="categoria.id"  v-bind:titulo="categoria.titulo" v-bind:filmes="categoria.flimes"></categoria>
  </div>
      ...
      categorias:[] /*[
        {
          ...
          "filmes":[
            {
                "id": 1, "titulo": "It: A coisa", "imagem":"https://img1.ibxk.com.br/2015/11/12/12134915138723.jpg?w=700"
            },
            {
                "id": 2, "titulo": "It: A coisa", "imagem":"https://img1.ibxk.com.br/2015/11/12/12134915138723.jpg?w=700"
            }
          ]
        }
      ]*/
